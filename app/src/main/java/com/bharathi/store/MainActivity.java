...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        if (firebaseUser == null){
            Intent intent = new Intent(MainActivity.this, PhoneNumberVerificationActivity.class);
        ...
        reference.addValueEventListener(new ValueEventListener(){
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
               UserProfile userProfile = dataSnapshot.getValue(UserProfile.class);
                session.createLoginSession(userProfile.getName(),userProfile.getEmailId(),userProfile.getPhoneNumber(),"");
                countFirebaseValues(userProfile.getPhoneNumber());
    ...
    private void countFirebaseValues(String sessionMobile) {
