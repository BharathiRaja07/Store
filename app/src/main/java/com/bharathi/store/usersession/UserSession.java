package com.bharathi.store.usersession;
...
import com.bharathi.store.PhoneNumberVerificationActivity;
...
public class UserSession {
    ...
    public void checkLogin(){
        ...
        if(!this.isLoggedIn()){
            ...
            Intent i = new Intent(context, PhoneNumberVerificationActivity.class);
